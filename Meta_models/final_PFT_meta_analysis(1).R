...
ies.da1$Tryp_species12<- as.factor(ies.da1$Tryp_species12)
...
g3<- rma.mv(yi, vi,data= ies.da1, mods=~Tryp_species12-1, method= "REML")
...
#-------------------------#
gr<-rma.mv(yi, vi,data= ies.da1, method= "REML",random= list(~ host|study_ID, ~Tryp_species12|study_ID) )
gr1<- rma.mv(yi, vi,data= ies.da1, mods=~md-1, method= "REML",random= list(~ host|study_ID, ~Tryp_species12|study_ID) )
gr2<- rma.mv(yi, vi,data= ies.da1, mods=~host-1, method= "REML", random= list(~ host|study_ID, ~Tryp_species12|study_ID))
gr3<- rma.mv(yi, vi,data= ies.da1, mods=~Tryp_species12-1, method= "REML", random= list(~ host|study_ID, ~Tryp_species12|study_ID))
gr4<- rma.mv(yi, vi,data= ies.da1, mods=~dm-1, method= "REML", random= list(~ host|study_ID, ~Tryp_species12|study_ID))
gr5<- rma.mv(yi, vi,data= ies.da1, mods=~insec-1, method= "REML", random= list(~ host|study_ID, ~Tryp_species12|study_ID))
...
gr5.1<- rma.mv(yi, vi,data= ies.da1, mods=~insec1, method= "REML", random= list(~ host|study_ID, ~Tryp_species12|study_ID))
gr6<- rma.mv(yi, vi,data= ies.da1, mods=~insec1-1, method= "REML", random= list(~ host|study_ID, ~Tryp_species12|study_ID))
...
m.3<- rma.mv(yi, vi,  mods=~Tryp_species1, random= list(~ host|study_ID, ~Tryp_species1|study_ID), data= ies.dm, method= "REML")
m.4<- rma.mv(yi, vi,  mods=~insec, random= list(~ host|study_ID, ~Tryp_species1|study_ID), data= ies.dm, method= "REML")
m.5<- rma.mv(yi, vi,  mods=~genus-1, subset=insec=="1", random= list(~ host|study_ID, ~Tryp_species1|study_ID), data= ies.dm, method= "REML")
...
m_insec2<- rma.mv(yi, vi,  mods=~Tryp_species1-1, random= list(~ host|study_ID, ~Tryp_species1|study_ID), data= insect_datam1, method= "REML")
...
orchard_plot(m_insec2, mod = "Tryp_species1", xlab = "infection propotion Trypanosma_group ", alpha = 0.5, angle=0)
...
WM_bees1=rma.mv(yi,vi,data=b1.data, mods= ~WM, subset=genus1=="Apis_spp.", random= list(~Tryp_species1|study_ID, ~host_species1|study_ID))
...
WM_bees2=rma.mv(yi,vi,data=b1.data, mods= ~WM, subset=genus1=="Bombus_spp.", random= list(~Tryp_species1|study_ID, ~host_species1|study_ID ))
...
WM_all_bees=rma.mv(yi,vi,data=b1.data, mods= ~WM, random= list(~Tryp_species1|study_ID))
